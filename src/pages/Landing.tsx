        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="space-y-6">
              <h1 className="text-6xl lg:text-7xl font-bold tracking-tight text-white leading-[1.1]">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button
                size="lg"
                onClick={handleGetStarted}
                className="bg-white text-black hover:bg-zinc-200 text-base group"
              >
                Start Free Trial
              ...
              <Button 
                ...
                className="text-white border-zinc-700 hover:bg-zinc-900 text-base"
              >
          ...
          >
            ...
            <div className="relative bg-zinc-900/50 backdrop-blur-sm rounded-2xl border border-zinc-800 overflow-hidden">
              ...
              <button 
                onClick={() => setIsVideoModalOpen(true)}
                className="absolute inset-0 flex items-center justify-center opacity-0 hover:opacity-100 transition-opacity duration-300 bg-black/40 backdrop-blur-sm"
              >
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                size="lg"
                onClick={handleGetStarted}
                className="bg-white text-black hover:bg-zinc-200 text-base"
              >
                Start Free Trial
                <ArrowRight className="w-4 h-4 ml-2" />
              </Button>

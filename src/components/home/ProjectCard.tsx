  ...
  return (
    <>
      <GlassCard 
        ...
        particle
        shimmer
        className="overflow-hidden cursor-pointer group hover:scale-[1.02] hover:-translate-y-1 transition-all duration-300 hover:shadow-[0_8px_32px_hsl(var(--cosmic-stellar)/0.4)] will-change-transform"
